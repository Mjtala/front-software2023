            ...
            <div className="contenedorcompleto">
                ...
                <div className="izq">
                    ...
                    <form className="formularioingreso">
                        ...
                        <button type="button" onClick={()=>navigate("/SignUpEmpresa")} className="boton-inicio-registro">Registrarse</button>
                    ...
                    <div className="col-xl-10">
                        ...
                        <div className="row g-0">
                            ...
                            <div className="card-body p-md-5 mx-md-4">
                                ...
                                <form>
                                <p className="subtitle-login">Ingresa a tu cuenta Empresa</p>
                            ...
                            <div className="text-white px-3 py-4 p-md-5 mx-md-4">
                                ...
                                <h4 className="mb-4">¿Quieres seguir arrendando tu cancha?</h4>
